    ...
    <main className="max-w-5xl mx-auto px-4 min-h-[70vh] grid place-items-center dark:bg-gray-900 dark:text-white">
      <section className="max-w-3xl text-center space-y-6">
        <img
          ...
          className="block mx-auto w-32 h-32 md:w-[220px] md:h-[220px] rounded-full object-cover shadow"
          loading="lazy"
        />
        ...
        <nav aria-label="Primary">
          <ul className="flex items-center justify-center gap-6">
            ...
            <li><a className="underline underline-offset-4 hover:opacity-80 focus:outline-none focus:ring" href="/links">Links</a></li>
          </ul>
        </nav>
      </section>
    </main>
